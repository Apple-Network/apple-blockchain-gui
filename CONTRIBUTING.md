...
This repo includes the code for the Apple GUI in electron/react and TypeScript.
...
If you want to learn more about this project, read the [wiki](https://github.com/Apple-Network/apple-blockchain/wiki), or check out the [green paper](https://www.apple.network/assets/AppleGreenPaper.pdf).
...
Contact any of the team members on [Keybase](https://keybase.io/team/apple_network.public), which we use as the main communication method and you can comment on any Trello card.
