import type { KeyData } from '@apple-network/api';
import {
  usePrefs,
...
import { AppleBlack, Coins } from '@apple-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with Apple.</Trans>
              </Typography>
              <Button
