...
import appleToMojo from '../../utils/appleToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isAppleCurrency = ['APPLE', 'TAPPLE'].includes(currencyCode);
  const mojo = isAppleCurrency ? appleToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isAppleCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
