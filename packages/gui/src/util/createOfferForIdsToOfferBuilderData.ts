import { toBech32m, WalletType } from '@apple-network/api';
import { mojoToApple, mojoToCAT } from '@apple-network/core';
      ...
      if (asset) {
        switch (asset.walletType) {
          case WalletType.STANDARD_WALLET:
            section.apple.push({ amount: mojoToApple(numericValue.abs()).toFixed() });
            break;
          case WalletType.CAT:
