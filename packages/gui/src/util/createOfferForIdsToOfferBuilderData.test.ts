import * as appleCore from '@apple-network/core';
...
describe('createOfferForIdsToOfferBuilderData', () => {
  ...
  describe('when offering APPLE for CAT', () => {
    it('should return a valid offer builder data object', () => {
      ...
      appleCore.mojoToApple.mockReturnValue(new BigNumber(111.555));
      appleCore.mojoToCAT.mockReturnValue(new BigNumber(600));
  ...
  describe('when offering a CAT for APPLE', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      appleCore.mojoToApple.mockReturnValue(new BigNumber(2));
      appleCore.mojoToCAT.mockReturnValue(new BigNumber(1.234));
  ...
  describe('when offering APPLE for an NFT', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      appleCore.mojoToApple.mockReturnValue(new BigNumber(3));
  ...
  describe('when the offered asset is for an unknown wallet type', () => {
    it('should ignore the unknown wallet assets', () => {
      ...
      appleCore.mojoToApple.mockReturnValue(new BigNumber(0.5));
  ...
  describe('when lookupByWalletId throws', () => {
    ...
    it('should ignore the asset that caused the error', () => {
      ...
      appleCore.mojoToApple.mockReturnValue(new BigNumber(5));
      appleCore.mojoToCAT.mockReturnValue(new BigNumber(1000));
