import type { OfferSummaryRecord, Wallet } from '@apple-network/api';
import { useTakeOfferMutation } from '@apple-network/api-react';
import { AlertDialog, appleToMojo, useOpenDialog, useShowError } from '@apple-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? appleToMojo(fee) : new BigNumber(0);
