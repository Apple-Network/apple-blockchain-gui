import api, { store, useGetLoggedInFingerprintQuery } from '@apple-network/api-react';
import { useOpenDialog, useAuth } from '@apple-network/core';
...
const log = debug('apple-gui:walletConnectCommand');
