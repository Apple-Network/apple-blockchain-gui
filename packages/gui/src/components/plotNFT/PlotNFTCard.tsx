import { useDeleteUnconfirmedTransactionsMutation } from '@apple-network/api-react';
import {
  Button,
  Color,
  TooltipTypography,
...
import { Plot as PlotIcon } from '@apple-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToAppleLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
