import type { PlotNFT, PlotNFTExternal } from '@apple-network/api';
import { useGetPoolLoginLinkQuery } from '@apple-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@apple-network/core';
