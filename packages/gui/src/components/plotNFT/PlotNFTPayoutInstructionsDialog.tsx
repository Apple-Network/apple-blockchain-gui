import { Button, CopyToClipboard, Flex, Link, Loading, TextField, Form } from '@apple-network/core';
            ...
            {loading ? (
              ...
              <Flex flexDirection="column" gap={2}>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    These are the instructions for how the farmer wants to get paid. By default this will be an APPLE
                  ...
                  <Link
                    target="_blank"
                    href="https://github.com/Apple-Network/pool-reference/blob/main/SPECIFICATION.md#payloadpayout_instructions"
                    noWrap
                  >
