import type { UnconfirmedPlotNFT } from '@apple-network/api';
import { useGetTransactionQuery } from '@apple-network/api-react';
import { Flex, Link, Loading } from '@apple-network/core';
