import { Button, Flex, Loading, CardStep, RadioGroup, EstimatedFee, FeeTxType, TextField } from '@apple-network/core';
            ...
            <FormControl variant="filled" fullWidth>
              <RadioGroup name="self" boolean>
                <Flex gap={1} flexDirection="column">
                  <FormControlLabel
                    control={<Radio />}
                    label={<Trans>Self pool. When you win a block you will earn APPLE rewards.</Trans>}
                    value
                  />
                  <Flex gap={2}>
