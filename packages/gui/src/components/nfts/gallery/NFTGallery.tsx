...
import { Flex, LayoutDashboardSub, Loading, /*useTrans,*/ usePersistState } from '@apple/core';
// import { defineMessage } from '@lingui/macro';
import { WalletReceiveAddressField } from '@apple/wallets';
import type { NFTInfo, Wallet } from '@apple/api';
import { useGetNFTWallets } from '@apple/api-react';
