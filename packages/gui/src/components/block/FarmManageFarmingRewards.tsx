...
import { Button, Flex, Form, TextField, Loading } from '@apple/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@apple/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25APPLE reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
