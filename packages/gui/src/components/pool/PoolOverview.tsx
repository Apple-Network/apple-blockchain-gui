...
import { Flex, UnitFormat, More, Table, mojoToAppleLocaleString, Suspender } from '@apple/core';
...
import { WalletStatus } from '@apple/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToAppleLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
