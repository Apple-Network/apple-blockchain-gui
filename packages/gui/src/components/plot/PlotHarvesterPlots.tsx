import { type Plot } from '@apple-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@apple-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@apple-network/core';
