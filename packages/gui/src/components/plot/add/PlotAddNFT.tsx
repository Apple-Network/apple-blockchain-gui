import { Button, CardStep, Select, Flex, Link, Loading } from '@apple-network/core';
    ...
    >
      ...
      {!loading && hasNFTs && (
        <>
          <Typography variant="subtitle1">
            ...
            &nbsp;
            <Link target="_blank" href="https://docs.applecoin.in/pool-farming">
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent APPLE farming rewards. Create a plot NFT and assign your new plots to a
              group.
            </Trans>
          </Typography>
