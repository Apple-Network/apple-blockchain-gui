...
import { defaultPlotter } from '@apple/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@apple/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { useForm, SubmitHandler } from 'react-hook-form';
import { useShowError, ButtonLoading, Flex, Form, FormBackButton } from '@apple/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    ...
    defaultValues: defaultsForPlotter(PlotterName.APPLEPOS),
  });
