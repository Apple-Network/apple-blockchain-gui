import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@apple-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Apple-Network/apple-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
