...
import { CardStep, Select, StateColor } from '@apple/core';
import { useGetPlottersQuery } from '@apple/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@apple/api';
import type { Plotter, PlotterMap } from '@apple/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort applepos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.APPLEPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Apple Proof of Space plotter. If unsure,
            use the default Apple Proof of Space plotter.
        </Trans>
      </Typography>
