import { defaultPlotter, PlotterName } from '@apple-network/api';
import type { Plotter, PlotterMap } from '@apple-network/api';
import { useGetPlottersQuery } from '@apple-network/api-react';
import { CardStep, Select, StateColor } from '@apple-network/core';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Apple Proof of Space plotter. If unsure, use the default Apple Proof of Space plotter.
        </Trans>
      </Typography>
