import { useRefreshPlotsMutation } from '@apple-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@apple-network/core';
import { Plots } from '@apple-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Apple. &nbsp;
              <Link target="_blank" href="https://github.com/Apple-Network/apple-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
