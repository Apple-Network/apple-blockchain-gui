...
import { CardHero, Flex, Link, useOpenDialog } from '@apple/core';
import { PlotHero as PlotHeroIcon } from '@apple/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://github.com/Apple-Network/apple-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
