import { toBech32m, fromBech32m } from '@apple-network/api';
import { useGetCurrentAddressQuery, useSendNotificationMutation } from '@apple-network/api-react';
import {
  AlertDialog,
  Amount,
  ButtonLoading,
...
export default function NotificationSendDialog(props: NotificationSendDialogProps) {
  ...
  async function handleSubmit(values: NotificationSendDialogFormData) {
    ...
    const amountMojos = appleToMojo(amount);
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                      <EstimatedFee
                        ...
                        txType={FeeTxType.walletSendAPPLE}
