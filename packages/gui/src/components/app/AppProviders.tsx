...
import WalletConnectProvider, { WalletConnectAppleProjectId } from '../walletConnect/WalletConnectProvider';
                        ...
                        <AddressBookProvider>
                          <OffersProvider>
                            <NotificationsProvider>
                              <WalletConnectProvider projectId={WalletConnectAppleProjectId}>
