import { Button, Color, Flex, Logo, Card, useMode, Mode } from '@apple-network/core';
import { Farming as FarmingIcon } from '@apple-network/icons';
                  ...
                  <Flex flexDirection="column" gap={1.5} flexGrow={1}>
                    <Flex gap={1} alignItems="center">
                      ...
                      <Typography variant="body2">
                        <Trans>Store and Send APPLE</Trans>
                      </Typography>
                    </Flex>
                    <Flex gap={1} alignItems="center">
                      <StyledCheckIcon color="primary" />
