import { Button, Flex } from '@apple-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Apple application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Apple services version: {backV}
                <br />
                Apple application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Apple application and stop all Apple services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
