...
import { useCreateOfferForIdsMutation } from '@apple/api-react';
...
import { appleToMojo, catToMojo } from '@apple/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = appleToMojo(formData.fee ?? 0);
