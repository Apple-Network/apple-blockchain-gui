...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@apple/api-react';
import { Wallet, WalletType } from '@apple/api';
    ...
    if (
      ...
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToAppleLocaleString(
          ...
          <Flex flexDirection="column" gap={1}>
            ...
            {tradeSide === 'sell' && row.assetWalletId > 0 && (
              <Flex flexDirection="row" alignItems="center" gap={1}>
                <Typography variant="body2"><Trans>Spendable balance: </Trans></Typography>
