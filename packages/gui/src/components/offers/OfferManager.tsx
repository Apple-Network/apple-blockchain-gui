import { OfferTradeRecord, toBech32m } from '@apple-network/api';
import {
                  ...
                  <Flex flexDirection="column" gap={4} height="100%">
                    <Flex flexDirection="column" gap={2} flexGrow={1}>
                      ...
                      <Typography variant="body1" color="textSecondary">
                        <Trans>
                          Create a file that you can use to trade APPLE, Apple Asset Tokens, or NFTs with no counter-party
                          risk.
                        </Trans>
                      </Typography>
                    </Flex>
...
export function CreateOffer() {
  ...
  const testnet = currencyCode === 'TAPPLE';
