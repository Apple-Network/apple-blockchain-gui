...
import { OfferTradeRecord, toBech32m } from '@apple/api';
import {
  Button,
  Checkbox,
  Dialog,
...
const testnetDummyHost = 'offers-api-sim.applecoin.in';
...
async function postToOfferBin(
  ...
  if (testnet) {
    return 'https://www.applecoin.in/offers';
  }
...
enum HashgreenErrorCodes {
  ...
  MARKET_NOT_FOUND = 50029, // Pairing doesn't exist e.g. APPLE/RandoCoin
...
const KeybaseTeamName = 'apple_offers';
...
function OfferShareKeybaseDialog(props: OfferShareServiceDialogProps) {
  ...
  const teamName = testnet ? 'testappleoffersdev' : KeybaseTeamName;
