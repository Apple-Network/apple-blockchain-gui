import { Flex, MenuItem, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@apple-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              WalletConnect enables a decentralized app on the Apple blockchain to communicate and make requests directly
              to a Apple wallet.
            </Trans>
          </SettingsText>
        </Flex>
                ...
                <Grid item container style={{ width: '400px' }} gap={2}>
                  <SettingsText>
                    <Trans>
                      ...
                      command issued by the Dapp will require confirmation in the Apple wallet.
                    </Trans>
                  </SettingsText>
                </Grid>
              </>
