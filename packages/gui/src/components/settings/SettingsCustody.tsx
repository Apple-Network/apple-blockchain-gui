...
import { Flex, SettingsHR, SettingsSection, SettingsText } from '@apple-network/core';
...
export default function SettingsCustody() {
  ...
  return (
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      ...
      <Box>
        <SettingsSection>
          <Trans>Default claw back time for outgoing APPLE transactions</Trans>
        </SettingsSection>

        <SettingsText>
          <Trans>Set a default time frame for all outbound APPLE transactions.</Trans>
        </SettingsText>
