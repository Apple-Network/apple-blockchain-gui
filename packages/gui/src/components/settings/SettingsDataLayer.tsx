import { Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@apple-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              DataLayer enables rich data to be stored on mirrored databases that can be verified using the Apple
              Blockchain.
            </Trans>
          </SettingsText>
        </Flex>
      ...
      <Grid container>
        ...
        <Grid item container style={{ width: '400px' }} gap={2}>
          ...
          <FormHelperText>
            <Trans>Changes will take effect the next time Apple is started.</Trans>
          </FormHelperText>
        </Grid>
      </Grid>
