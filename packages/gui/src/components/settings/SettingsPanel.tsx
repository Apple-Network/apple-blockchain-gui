...
import { useGetKeyringStatusQuery } from '@apple-network/api-react';
import {
  AlertDialog,
  Button,
  Color,
              ...
              <Flex gap={1} alignItems="center">
                ...
                <TooltipIcon>
                  <Trans>
                    ...
                    This number is generally higher if you have a lot of transactions or canceled offers for APPLE, CATs,
