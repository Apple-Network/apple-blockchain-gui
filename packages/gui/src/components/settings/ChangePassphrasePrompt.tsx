...
import { AlertDialog, Button, DialogActions, Flex, useOpenDialog, Suspender, useValidateChangePassphraseParams } from '@apple/core';
import { useGetKeyringStatusQuery, useRemoveKeyringPassphraseMutation, useSetKeyringPassphraseMutation } from '@apple/api-react';
      ...
      <DialogContent>
        ...
        {!!canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip title={t`Your passphrase can be stored in your system's secure credential store. Apple will be able to access your keys without prompting for your passphrase.`}>
