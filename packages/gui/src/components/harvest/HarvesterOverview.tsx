import { NewFarmingInfo } from '@apple-network/api';
import { useGetBlockchainStateQuery, useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@apple-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple, useCurrencyCode } from '@apple-network/core';
...
export default function HarvesterOverview() {
  ...
  const isTestnet = (useCurrencyCode() ?? 'APPLE').toUpperCase() === 'TAPPLE';
