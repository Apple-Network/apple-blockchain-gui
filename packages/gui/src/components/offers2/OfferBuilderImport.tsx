import { useGetOfferSummaryMutation } from '@apple-network/api-react';
import { Color, Dropzone, Flex, useSerializedNavigationState, useShowError } from '@apple-network/core';
