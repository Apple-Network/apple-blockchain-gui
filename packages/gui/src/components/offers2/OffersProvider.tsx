...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@apple-network/api-react';
import { isValidURL } from '@apple-network/core';
...
const log = debug('apple-gui:OfferProvider');
