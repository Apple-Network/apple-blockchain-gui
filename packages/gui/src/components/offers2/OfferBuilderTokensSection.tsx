...
import { useGetWalletsQuery } from '@apple-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@apple-network/core';
import { Tokens } from '@apple-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Apple Asset Tokens (CATs) are tokens built on top of APPLE</Trans>}
