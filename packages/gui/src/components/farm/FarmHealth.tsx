...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@apple-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.applecoin.in/faq/#why-does-my-apple-farm-say-missing-signage-points">
