...
import { NFTInfo } from '@apple-network/api';
...
import AppIcon from '../assets/img/apple64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import appleEnvironment from '../util/appleEnvironment';
...
// Set the userData directory to its location within APPLE_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!appleEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      appleEnvironment.startAppleDaemon();
    }
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'Apple Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/Apple-Network/apple-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/Apple-Network/apple-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/Apple-Network/apple-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/Apple-Network/apple-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/Apple-Network/apple-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/apple');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/apple_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // Apple Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'Apple' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About Apple Blockchain' }),
          click: () => {
            openAbout();
          },
        },
