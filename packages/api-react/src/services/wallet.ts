...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC } from '@apple-network/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@apple-network/api';
