...
import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@apple/api-react';
import styled from 'styled-components';
import WalletGraph from '../WalletGraph';
import { CardSimple, Flex, TooltipIcon } from '@apple/core';
          ...
          <Flex alignItems="center" gap={1}>
            ...
            <TooltipIcon>
              <Trans>
                ...
                This number is generally higher if you have a lot of transactions or canceled offers for APPLE, CATs, or NFTs.
