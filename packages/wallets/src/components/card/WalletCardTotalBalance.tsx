import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@apple-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@apple-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for APPLE, CATs, or
