import { TransactionType } from '@apple-network/api';
import type { Transaction } from '@apple-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@apple-network/api-react';
import { useTrans, Button } from '@apple-network/core';
