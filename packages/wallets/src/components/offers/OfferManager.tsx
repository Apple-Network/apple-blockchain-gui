...
import { Trade as TradeIcon } from '@apple/icons';
import { useCancelOfferMutation, useGetOfferDataMutation, useGetWalletsQuery } from '@apple/api-react';
...
function ConfirmOfferCancellation(props: ConfirmOfferCancellationProps) {
  ...
  async function handleConfirm() {
    ...
    if (cancelWithTransaction) {
      fee = Number.parseFloat(appleToMojo(xchFee));
    }
      ...
      <Grid container>
        <Grid xs={12} md={6} lg={5} item>
          <CardHero>
            ...
            <Typography variant="body1">
              <Trans>
                Create an offer to exchange APPLE or other tokens. View an offer to inspect and accept an offer made by another party.
              </Trans>
            </Typography>
