import type { CATToken } from '@apple-network/api';
import { SyncingStatus } from '@apple-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@apple-network/api-react';
import { Back, Flex, Loading, useShowError } from '@apple-network/core';
