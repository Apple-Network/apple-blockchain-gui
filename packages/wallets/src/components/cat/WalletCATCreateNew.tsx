...
import { appleToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@apple/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = appleToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Apple Asset Token Wallet</Trans>
        </Back>
        <Card>
