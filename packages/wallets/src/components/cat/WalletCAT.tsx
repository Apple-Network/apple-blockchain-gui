...
import { Flex, Loading, useOpenDialog } from '@apple/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@apple/api-react';
import { Offers as OffersIcon } from '@apple/icons';
