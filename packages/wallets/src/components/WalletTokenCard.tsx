...
import { useSetCATNameMutation } from '@apple/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@apple/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'Apple' : name;
