...
import { AlertDialog, Card, Flex, appleToMojo, mojoToAppleLocaleString } from '@apple/core';
import {
  send_transaction,
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToAppleLocaleString(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const fee = appleToMojo(fee_input.value);
