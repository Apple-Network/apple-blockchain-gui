import { english } from '@apple-network/api';
import { useAddPrivateKeyMutation } from '@apple-network/api-react';
import {
  AlertDialog,
  Autocomplete,
  Button,
      ...
      <Container maxWidth="lg">
        <Flex flexDirection="column" gap={3} alignItems="center">
          ...
          <Typography variant="subtitle1" align="center">
            <Trans>
              Enter the {mnemonicWordCount} word mnemonic that you have saved in order to restore your Apple wallet.
            </Trans>
          </Typography>
