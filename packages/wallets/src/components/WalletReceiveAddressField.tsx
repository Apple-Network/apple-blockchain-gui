import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@apple-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@apple-network/core';
import { Reload } from '@apple-network/icons';
