...
describe('toBech32m', () => {
  describe('toBech32m', () => {
    it('should convert a hex string to a bech32m string', () => {
      ...
      const bech32mString = toBech32m(hexString, 'apple');

      expect(bech32mString).toBe('apple1dfjkvenf0f4k2amv2y5f9j');
    });
    ...
    it('should check if the input begins with the prefix', () => {
      const hexString = 'apple1dfjkvenf0f4k2amv2y5f9j';
      const bech32mString = toBech32m(hexString, 'apple');
