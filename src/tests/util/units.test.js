...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of apple', () => {
      const result = units.getUnit('apple');
    ...
    it('gets unit of apple using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of apple', () => {
      const result = units.getDisplay('apple');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('apple', 9);

      const result = units.getUnit('apple');

      expect(result).toEqual(9);

      units.setUnit('apple', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('apple', {
        format: '{amount} TAPPLE',
        fractionDigits: 0,
      });
