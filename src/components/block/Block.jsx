...
export default function Block() {
  ...
  const poolReward = mojo_to_apple(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = mojo_to_apple(
    calculateBaseFarmerReward(blockRecord.height),
  );

  const appleFees = blockRecord.fees
    ? mojo_to_apple(BigInt(blockRecord.fees))
    : '';
