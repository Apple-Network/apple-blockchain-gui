...
import { /* mojo_to_apple_string, */ apple_to_mojo } from '../../../util/apple';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_apple_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of apple in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Apple that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Apple that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send apple to coloured address. Please enter a apple
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'apple_addr://') {
    ...
    const amountValue = Number.parseFloat(apple_to_mojo(amount));
    const feeValue = Number.parseFloat(apple_to_mojo(fee));
